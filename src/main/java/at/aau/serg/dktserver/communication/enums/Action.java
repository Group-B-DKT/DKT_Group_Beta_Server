...
public enum Action {
    ...
    READY, NOT_READY, CHANGED_READY_STATUS, LEAVE_GAME, HOST_CHANGED, INIT_FIELDS, GAME_DELETED, GAME_STARTED, MOVE_PLAYER, END_TURN, RISIKO_CARD_SHOW, BANK_CARD_SHOW
}
